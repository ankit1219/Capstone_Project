...
public class FlyClass {
	...
	public String[] exp_details() {
		...
		driver.findElement(By.xpath("//input[@name=\"email_id\"]")).sendKeys("ankitku7@cisco.com");
		driver.findElement(By.xpath("//input[@name=\"pwd\"]")).sendKeys("ankitku");
		driver.findElement(By.xpath("//button")).click();
		driver.findElement(By.linkText("Logout")).click();
		
		
		String exp_email="ankitku7@cisco.com";
		String exp_pwd ="ankitku";
		String exp_name = "Ankit";
		String exp_adress ="Dwarka";
		String exp_city ="New Delhi";
